...
data_input_folder = '/projects/b1053/joe/photoz/3_cleaning/filtered_output/*.csv'
...
RF_reg = RandomForestRegressor(n_estimators=1000, random_state=42, verbose=2, n_jobs=-1)
